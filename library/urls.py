...
urlpatterns = [
    ...
    path('adminlogin', LoginView.as_view(template_name='adminlogin.html'),name='admin-login'),
    path('studentlogin', LoginView.as_view(template_name='studentlogin.html'),name='student-login'),
